...
# usage python baseline_ocsvm.py anoshift_db_path full_set 
#
...
if __name__=="__main__":
    ...
    for train_years, test_years in pair_years:
        ...
        sys.stdout.flush()
        # we have considered different configurations for the scaler: RobustScaler, StandardScaler, MinMaxScaler
        scaler = RobustScaler()
