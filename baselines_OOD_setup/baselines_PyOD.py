...
# usage:
#       python baselines_PyOD.py method_name anoshift_db_path train_data_percent
# 
...
if __name__=="__main__":
    ...
    X_train, enc, data_mean, data_std = load_anoshift.get_train(anoshift_db_path, train_data_percent=train_data_percent)
